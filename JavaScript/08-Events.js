...
console.log("Events");
console.log(`HTML events are "things" that happen to HTML elements.`);
...
- element: the DOM element you're targeting
- "eventType": a string like "click", "input", "submit", "keydown", etc.
...
"input"         - User types into a form field
